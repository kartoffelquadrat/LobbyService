...
public class AuthorizationServerConfiguration extends AuthorizationServerConfigurerAdapter {
    ...
    @Value("${access.token.timeout}")
    int accessTokenTimeout;

    @Value("${refresh.token.timeout}")
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        ...
        clients.
                ...
                .accessTokenValiditySeconds(accessTokenTimeout). //Access token is only valid for 30 minutes.
                refreshTokenValiditySeconds(refreshTokenTimeout); //Refresh token is only valid for 4 hours.
    }
